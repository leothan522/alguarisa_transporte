...
@section('content')
    ...
    <div x-data class="text-center mb-5 mb-sm-auto">
        @auth
            ...
            <a class="text-muted ms-3" href="{{ route('web.home') }}" @click="mostrarPreloader()">Dashboard</a>
        @else
            <a class="text-muted" href="{{ route('web.home') }}" @click="mostrarPreloader()">{{ __('Log in') }}</a>
